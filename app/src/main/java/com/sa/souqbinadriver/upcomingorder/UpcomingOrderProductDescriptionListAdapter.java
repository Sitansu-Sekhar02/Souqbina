...
public class UpcomingOrderProductDescriptionListAdapter extends RecyclerView.Adapter<UpcomingOrderProductDescriptionListAdapter.ViewHolder> {


        public static final String TAG = "UpcomingOrderProductDescriptionListAdapter";

            private List<OrderModel> mModel;
            private final Activity activity;

        public UpcomingOrderProductDescriptionListAdapter(List<OrderModel> mModel, Activity activity) {
            this.mModel = mModel;
