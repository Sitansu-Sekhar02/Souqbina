package com.sa.souqbinadriver.notification;
...
//        actionBar = getSupportActionBar();
    ...
    private void showErrorPage() {
        if (progressLinearLayout != null) {
            progressLinearLayout.showError(getResources().getDrawable(R.mipmap.app_icon), getString(R.string.noConnection),
    ...
    private void showEmptyPage() {
        if (progressLinearLayout != null) {
            progressLinearLayout.showEmpty(getResources().getDrawable(R.mipmap.app_icon), getString(R.string.emptyList),
