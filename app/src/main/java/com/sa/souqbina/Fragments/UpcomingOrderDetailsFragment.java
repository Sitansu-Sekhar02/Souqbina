...
public class UpcomingOrderDetailsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.upcoming_order_details, container, false);
        ...
        MainActivity.tvHeaderText.setText(getString(R.string.upcoming_order_details));
